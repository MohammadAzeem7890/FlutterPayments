...
class _PaymentState extends State<Payment> {
  ...
  String _error;
  final String _currentSecret = "sk_test_51IhEBcKHVg3RWoqaXEnLLoHJ1YM5jVPrVzqgJ1LmCSTqwAizfxYR5MPcdnClyk522za6qackJzjZQUJNWUpdvX0b00THUpNxvh"; //set this yourself, e.g using curl
  ...
  initState() {
    ...
    StripePayment.setOptions(
        StripeOptions(publishableKey: "pk_test_51IhEBcKHVg3RWoqaNHHeLTG0EP06cKxyurwg9Ryik577ZA4oTYOgYXByit2OMpIPl14W2BwxqvCxLvVd7Y4qHtnc00zyPVPLbG",
            merchantId: "erchant_id",
            androidPayMode: 'test'));
  }
